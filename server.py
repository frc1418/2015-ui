...
#link is http://127.0.0.1:8888/UI_MainPage.html
if __name__ == '__main__':
    ...
    parser.add_option('--camUrl',default='http://10.14.18.2:8080',help='Camera feed url')
    ...
    www_dir = abspath(join(dirname(__file__), ''))
